        ...
        <div className='instructions_wrapper'>
            ...
            <div className="instructions">
                <div className='instructions_item'>
                    ...
                    <img className='instructions_item_img' src={holograma} alt='350px X 232px'/>
                ...
                <div className='instructions_item'>
                    ...
                    <img className='instructions_item_img' src={engranaje} alt='350px X 232px'/>
                    <div className='instructions_item_description'>
                ...
                <div className='instructions_item'>
                    ...
                    <img className='instructions_item_img' src={bienes} alt='350px X 232px'/>
                    <div className='instructions_item_description'>
